...
const form = useForm<Medicament>({
  id: props.medicament.id || null,
  nom:  props.medicament.nom,
  photos: props.medicament.photos, 
  stock: props.medicament.stock,
  prix: props.medicament.prix,
  dosage: props.medicament.dosage,
  ingredient: props.medicament.ingredient,
  date_peremption: props.medicament.date_peremption, 
  fabricant: props.medicament.fabricant, 
  date_fabrication: props.medicament.date_fabrication,
  type_medicament: props.medicament.type_medicament,
  description: props.medicament.description,
  forme_id: props.medicament.forme_id,
});
...
const submitForm = async () => {
  try {
    ...
    await form.post(route('medicament.update'));
