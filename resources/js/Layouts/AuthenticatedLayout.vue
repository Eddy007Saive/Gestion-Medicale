                ...
                <li class="nav-item">
                  ...
                  <div class="collapse" id="ui-basic">
                    <ul class="nav flex-column sub-menu">
                      <li class="nav-item"> <a class="nav-link" href="pages/ui-features/buttons.html">Specialités</a></li>
                    </ul>
                  </div>
                </li>
                <li class="nav-item">
                  <Link class="nav-link" :href="route('patient.all')">
                    <span class="menu-title">Patients</span>
                    <i class="mdi mdi-contacts menu-icon"></i>
                  </Link>
                </li>
                <li class="nav-item">
                  <a class="nav-link" :href="route('medicament.all')">
